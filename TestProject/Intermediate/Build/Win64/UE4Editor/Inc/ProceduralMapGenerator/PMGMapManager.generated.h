...
#ifdef PROCEDURALMAPGENERATOR_PMGMapManager_generated_h
#error "PMGMapManager.generated.h already included, missing '#pragma once' in PMGMapManager.h"
#endif
...
public: \
	DECLARE_CLASS(APMGMapManager, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ProceduralMapGenerator"), NO_API) \
...
#define TestProject_Source_ProceduralMapGenerator_Public_PMGMapManager_h_24_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, APMGMapManager); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APMGMapManager); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API APMGMapManager(APMGMapManager&&); \
	NO_API APMGMapManager(const APMGMapManager&); \
public:
...
template<> PROCEDURALMAPGENERATOR_API UClass* StaticClass<class APMGMapManager>();
